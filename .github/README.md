...
[`@aws-sdk/client-waf`](https://www.npmjs.com/package/@aws-sdk/client-waf/v/3.20.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-waf@3.20.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EONEStaPMElAbZ4irJcsNCORuiIzl0/6ov7Xq/prLO/6xIVH1FfOHHL4IOVWmSK0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-waf": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-waf@3.20.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-waf@3.20.0/index.min.mjs": "sha384-EONEStaPMElAbZ4irJcsNCORuiIzl0/6ov7Xq/prLO/6xIVH1FfOHHL4IOVWmSK0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-waf/blob/refs/tags/3.20.0/LICENSE
```
